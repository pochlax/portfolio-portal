...
export default function Hero() {
    return(
        <section id = "hero" className = "bg-gray-800 pt-20">
            <div>
                <h1 className = "text-green-400  md:ml-20 ml-60 md text-2xl pt-20 pb-5"> Hi, I am </h1>
                <div className = "text-6xl pb-10 font-extrabold  md:ml-20 ml-60">
                ...
                <div className = " md:ml-20 ml-60 text-2xl pb-40 w-96">
